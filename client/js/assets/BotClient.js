...
// public methods:
	...
	s.remoteBehavior = function(remoteBehavior) {
		case "commandWait":
		break;
		case "commandAttack":
			this.setTargetId(remoteBehavior.target.id);
			this.setHasTarget(true);
			this.setDestination({ x:cremoteBehavior.target.x, y:remoteBehavior.target.y} );
